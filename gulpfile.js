...
gulp.task("javascript_concat", function () {
  return gulp
    .src(["./tmp/vendor.js", "./tmp/babel.js"])
...
gulp.task("octicons", function () {
  return gulp
    .src("assets/vendor/octicons/octicons/**/*")
    .pipe(gulp.dest("output/assets/vendor/octicons/octicons"));
});

gulp.task("images", function () {
  return gulp.src("assets/images/**/*").pipe(gulp.dest("output/assets/images"));
});

gulp.task("favicon", function () {
  return gulp.src("assets/images/favicon.ico").pipe(gulp.dest("output/"));
});
...
gulp.task("nanoc:compile", function (cb) {
  ...
  const compile = spawn("bundle", ["exec", "nanoc", "compile"], {
    stdio: "inherit",
  });
...
gulp.task(
  "assets",
  gulp.parallel("css", "sass", "javascript", "octicons", "images", "favicon"),
);
gulp.task(
  "build",
  gulp.parallel("extract_api_docs_data", "nanoc:compile", "assets"),
);
