    ...
    (t.Index.prototype.search = function (e) {
      ...
      n.forEach(function (e, n, s) {
        var a = (1 / s.length) * this._fields.length * r,
          h = this,
          u = this.tokenStore.expand(e).reduce(function (n, o) {
      ...
      var t = {
        ...
        $ = function (n) {
          ...
          if (
            ...
            var $ = s.exec(n);
            (s = l), s.test($[1]) && ((s = y), (n = n.replace(s, "")));
          } else if (a.test(n)) {
            var $ = a.exec(n);
            (i = $[1]),
              (a = f),
          ...
          if (((s = b), s.test(n))) {
            var $ = s.exec(n);
            (i = $[1]), (o = $[2]), (s = l), s.test(i) && (n = i + t[o]);
          }
          if (((s = E), s.test(n))) {
            var $ = s.exec(n);
            (i = $[1]), (o = $[2]), (s = l), s.test(i) && (n = i + e[o]);
          }
          if (((s = _), (a = O), s.test(n))) {
            var $ = s.exec(n);
            (i = $[1]), (s = c), s.test(i) && (n = i);
          } else if (a.test(n)) {
            var $ = a.exec(n);
            (i = $[1] + $[2]), (a = c), a.test(i) && (n = i);
          }
          if (((s = F), s.test(n))) {
            var $ = s.exec(n);
            (i = $[1]),
